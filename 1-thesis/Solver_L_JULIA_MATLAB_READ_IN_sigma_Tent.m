...
function [] = Solver_L_JULIA_MATLAB_READ_IN_sigma_Tent()
%   Detailed explanation goes here
%ProcID=2
%NumberOfGaussPoints=[9 25 49 81]; % paper
NumberOfGaussPoints=[25    81   121   225   289   441   625   729];

str_folder="/home/philippe/Desktop/Beam_matlab/1-thesis/";
...
if(length(level)==1)
    ...
    if(HigherOrder==0) %Pure h refinement
        ...
        str_elements=str_folder+"h_refinement/";
    ...
    elseif(HigherOrder==1) %Pure p refinement
        ...
        Order=level_num+1;
        str_elements=str_folder+"p_refinement/";
...
%     vec_int=(-cos(ar)+1)/sum((-cos(ar)+1)).*1;
%     
%     
%     
...
figure
plotdisp(Nodes,Elements,Types,DOF,U(:,end),'DispScal',0.05)
...
DisplacedNodes(i,2)=DisplacedNodes(i,2)+xdis*0.05;
DisplacedNodes(i,3)=DisplacedNodes(i,3)+ydis*0.05;
...
hold on
plotnodes(DisplacedNodes,'numbering','off','*r','GCS','off','LineWidth',1.5)
