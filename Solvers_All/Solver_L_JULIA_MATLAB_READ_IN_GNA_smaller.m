...
function [] = Solver_L_JULIA_MATLAB_READ_IN_GNA_smaller(ProcID)
%   Detailed explanation goes here
%ProcID=2
%NumberOfGaussPoints=[9 25 49 81]; % paper
NumberOfGaussPoints=[25    81   121   225 ];
